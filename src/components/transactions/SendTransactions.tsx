...
import CompleteTxWithWitness from './CompleteTxWithWitness';
...
export default function SendTransactions(){
    ...
    const fetchChainMinInfor = async () => {
        ...
        const myWallets: Wallet[] = await blockchainApi.getWallets();
        const cc: ChainConfig = await blockchainApi.getChainConfig();
