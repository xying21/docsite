    ...
    async function fetchWallets() {
        ...
        setWallets( myWallets.map((wallet:Wallet, index:number) => {
            ...
            <li key={index} style={styles.wallet_panel}>
                <Typography style={styles.main_color}> Wallet {index + 1} </Typography>
    ...
    return (
        <Container style={ custom_style != undefined ? {...styles.wallet_section, ...custom_style} : styles.wallet_section}>
            <div style={styles.content}>
                 ...
                 Note: The wallet information is only used for demonstration in this tutorial. Do not use these private keys, addresses and args elsewhere.
                </p>
            </div>
