...
For more information, see the <Link to={useBaseUrl('/docs/tools/lumos/guides/buildtransactions#transfer-ckb-with-locktime-pool')}>Transfer CKB with Locktime Pool</Link> example.